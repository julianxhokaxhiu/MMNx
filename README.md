...
MMNx is an attempt to kickstart a mod manager that is free, open-source and easy to code and contribute.

For UI the main goal is to use HTML/CSS/JS while for the backend code is to use C/C++.
